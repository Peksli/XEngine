...
#pragma region WindowCloseEvent
	void WindowCloseEvent::OnEvent() {
		XEngine_INFO("WindowCloseEvent");
	}
...
#pragma region WindowResizeEvent
	...
	void WindowResizeEvent::OnEvent() {
		XEngine_INFO("WindowResizeEvent");
	}
...
#pragma region WindowMovedEvent
	...
	void WindowMovedEvent::OnEvent() {
		XEngine_INFO("WindowMovedEvent");
	}
